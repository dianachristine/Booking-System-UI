                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <template v-if="servicesStore.service">
                      <h3>{{ servicesStore.service.serviceName }}</h3>
                      <hr />
                      ...
                      <dl class="row">
                        ...
                        <InfoRow infoType="Hind"
                          :infoString=servicesStore.service.amount + servicesStore.service.currency />
                        ...
                        <InfoRow infoType="Lõplik hind"
                          :infoString=servicesStore.service.finalPrice + servicesStore.service.currency />
                      ...
                      <div>
                        <PinkButton buttonPathName="serviceedit" buttonText="Muuda" />
